...
import tools.objdet_models.resnet.utils.torch_utils as rnutils
...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        configs.name = 'darknet' # needed as the name of the results files do not match 'arch' for fpn_resnet_18
        ...
        configs.name = 'fpn_resnet' # needed as the name of the results files do not match 'arch' for fpn_resnet_18
        configs.conf_thresh = 0.5
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            outputs['hm_cen'] = rnutils._sigmoid(outputs['hm_cen'])
            outputs['cen_offset'] = rnutils._sigmoid(outputs['cen_offset'])
