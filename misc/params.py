...
tentative_threshold = 0.6 # track score threshold to switch from 'initialized' to 'tentative'
...
delete_threshold_initialized = 0.1 # track score threshold to delete initialized tracks
